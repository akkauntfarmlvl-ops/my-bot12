...
@dp.callback_query_handler(lambda c: c.data == "buy_cfg")
...
@dp.callback_query_handler(lambda c: c.data == "cfg_wifi")
...
@dp.callback_query_handler(lambda c: c.data == "wifi_stopflash")
...
@dp.callback_query_handler(lambda c: c.data == "pay_uah_80")
async def pay_uah_80(callback: CallbackQuery, state: FSMContext):
    ...
    await AdminState.waiting_screenshot.set()
...
@dp.message_handler(content_types=['photo'], state=AdminState.waiting_screenshot)
...
async def approve_purchase(callback: CallbackQuery, state: FSMContext):
    ...
    await AdminState.sending_purchase_file.set()
...
@dp.message_handler(content_types=['document'], state=AdminState.sending_purchase_file)
...
@dp.callback_query_handler(lambda c: c.data == "back_to_cfg")
...
@dp.callback_query_handler(lambda c: c.data == "cfg_mobile")
...
@dp.callback_query_handler(lambda c: c.data == "notify_mobile")
...
@dp.message_handler(Command("123"))
async def cmd_secret(message: Message, state: FSMContext):
    ...
    await AdminState.enter_password.set()


@dp.message_handler(state=AdminState.enter_password)
...
@dp.callback_query_handler(lambda c: c.data == "admin_add", state=AdminState.admin_menu)
async def admin_add(callback: CallbackQuery, state: FSMContext):
    ...
    await AdminState.waiting_file.set()


@dp.callback_query_handler(lambda c: c.data == "admin_list", state=AdminState.admin_menu)
...
@dp.callback_query_handler(lambda c: c.data == "admin_users", state=AdminState.admin_menu)
...
@dp.callback_query_handler(lambda c: c.data == "admin_delete", state=AdminState.admin_menu)
...
@dp.callback_query_handler(lambda c: c.data == "admin_purchases", state=AdminState.admin_menu)
...
@dp.message_handler(content_types=['document', 'photo', 'video', 'audio', 'voice'], state=AdminState.waiting_file)
async def handle_file_upload(message: Message, state: FSMContext):
    ...
    await AdminState.waiting_description.set()


@dp.callback_query_handler(lambda c: c.data == "skip_desc", state=AdminState.waiting_description)
async def skip_description(callback: CallbackQuery, state: FSMContext):
    await save_file(callback.message, state, description=None)


@dp.message_handler(state=AdminState.waiting_description)
